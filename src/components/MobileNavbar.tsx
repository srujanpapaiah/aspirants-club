...
const MobileNavbar: React.FC<MobileNavbarProps> = ({
  ...
  return (
    <>
      <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-[#07080B] py-2 px-4 flex justify-between items-center shadow-lg">
        ...
        <button onClick={onQuickActionsClick} className="flex flex-col items-center">
          <FiPlusCircle size={32} className="text-[#1AA38C]" />
          <span className="text-xs mt-1 text-gray-600 dark:text-gray-300">Actions</span>
        </button>
        <button onClick={onTimelineClick} className="flex flex-col items-center">
          <FiClock size={24} className="text-gray-600 dark:text-gray-300" />
          <span className="text-xs mt-1 text-gray-600 dark:text-gray-300">Timeline</span>
        </button>
        <button onClick={toggleLibrary} className="flex flex-col items-center">
          <FiBookOpen size={24} className="text-gray-600 dark:text-gray-300" />
      ...
      {isLibraryOpen && (
        <div className="fixed inset-0 bg-white dark:bg-[#07080B] z-50 overflow-y-auto">
          <div className="p-4">
            <button onClick={toggleLibrary} className="mb-4 text-gray-600 dark:text-gray-300">
              <FiX size={24} />
            </button>
